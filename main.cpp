...
int main()
{
    ...
    */
    ...
    cCompressionF A(TailleBlock,TailleBlock,ImageInit,50);
    cCompressionF F(TailleBlock,TailleBlock,ImageRLE,50);
    TListe=F.RLE(Liste);
    std::cout<<"Taille RLE : "<<TListe<<std::endl;
    ...
    THisto=F.Histogramme(Liste,TListe,Donnee,Frequence);
    std::cout<<"Taille Histo : "<<THisto<<std::endl;
    affichage1D(Donnee,THisto,"Donnees");
    affichage1D(Frequence,THisto,"Frequence");
    cHuffmanF W(Liste,THisto);
    W.HuffmanCodes(Y,X,6);
    W.HuffmanCodes(Donnee,Frequence,THisto);
    return 0;
}
